        ...
        <form className='grid p-4 gap-3 overflow-y-scroll h-full pb-5' onSubmit={handleSumbitProduct}>
          ...
          <div className='p-2 bg-slate-100 border rounded h-32 w-full flex justify-center items-center cursor-pointer'>
              <div className='text-slate-600 flex justify-center items-center flex-col gap-2'>
                ...
                <input type='file' id='uploadImageInput' required className='hidden' onChange={handleUploadProduct}/>
              </div>
          </div>
          </label>
          <div>
          ...
          <button className='bg-red-500 hover:bg-red-600 text-white px-4 py-1 rounded-full mb-10'>Upload Product</button>
        </form>
